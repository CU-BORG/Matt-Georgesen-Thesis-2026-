...
# Import the correct model architecture (DECAY-ONLY, NO IRF)
...
def plot_mean_std_comparison(stratified_results, group_name, save_dir):
    ...
    ax.set_title(f'{group_name} - Mean ± Std Comparison (DECAY-ONLY)', fontsize=14, fontweight='bold')
    ax.set_xticks(x)
    ...
    ax.set_ylabel(r'$\tau_1$ (ns)', fontsize=12, fontweight='bold')
    ax.set_xlabel('Photon Bin', fontsize=12, fontweight='bold')
    ax.set_title(f'{group_name} - ' + r'$\tau_1$ Mean ± Std Comparison (DECAY-ONLY)', fontsize=14, fontweight='bold')
    ax.set_xticks(x)
    ax.set_xticklabels(bin_names, fontsize=10)
    ax.legend(fontsize=11)
    ax.grid(True, alpha=0.3, axis='y')
    ...
    ax.set_ylabel(r'$\tau_2$ (ns)', fontsize=12, fontweight='bold')
    ax.set_xlabel('Photon Bin', fontsize=12, fontweight='bold')
    ax.set_title(f'{group_name} - ' + r'$\tau_2$ Mean ± Std Comparison (DECAY-ONLY)', fontsize=14, fontweight='bold')
    ax.set_xticks(x)
    ax.set_xticklabels(bin_names, fontsize=10)
    ax.legend(fontsize=11)
    ax.grid(True, alpha=0.3, axis='y')
    ...
    ax.set_ylabel('f', fontsize=12, fontweight='bold')
    ax.set_xlabel('Photon Bin', fontsize=12, fontweight='bold')
    ax.set_title(f'{group_name} - f Mean ± Std Comparison (DECAY-ONLY)', fontsize=14, fontweight='bold')
    ax.set_xticks(x)
    ax.set_xticklabels(bin_names, fontsize=10)
    ax.legend(fontsize=11)
    ax.grid(True, alpha=0.3, axis='y')
...
if __name__ == '__main__':
    # Configuration
    MODEL_PATH = r'C:\Users\mcg11923\Thesis\training_logs_decay_bin62_12.5ns_f2_longfrac_NoIRF_20260508_205315\model_final_decay_bin62_12.5ns_f2_longfrac_NoIRF.pth'
    REAL_DATA_DIR = r'E:\RealdataSCC74A\mat_files'
    OUT_DIR = r'C:\Users\mcg11923\Thesis\training_logs_decay_bin62_12.5ns_f2_longfrac_NoIRF_20260508_205315\real_data_photon_stratified_NoIRF'
    ...
    # Load model
    print("=" * 80)
    print("LOADING MODEL (DECAY-ONLY, NO IRF)")
    print("=" * 80)
    ...
    if not os.path.exists(MODEL_PATH):
        ...
        print("Please update MODEL_PATH to point to the trained NoIRF model checkpoint.")
        print("You need to train the model first using Training_LLE_BiExp_Autoencoder_DecayBin50_LongFraction_NoIRF.py")
        sys.exit(1)
    ...
    model.eval()
    print("Model loaded successfully (DECAY-ONLY)\n")
    ...
    print("=" * 80)
    print("PHOTON-STRATIFIED INFERENCE (DECAY-ONLY, NO IRF)")
    print("=" * 80)
    ...
    # Save summary
    summary_path = os.path.join(OUT_DIR, 'photon_stratified_summary_NoIRF.txt')
    with open(summary_path, 'w', encoding='utf-8') as f:
        f.write("=" * 80 + "\n")
        f.write("PHOTON-STRATIFIED INFERENCE (DECAY-ONLY, NO IRF)\n")
        f.write("=" * 80 + "\n\n")
    ...
    print("=" * 80)
    print("PHOTON-STRATIFIED ANALYSIS COMPLETE (DECAY-ONLY, NO IRF)")
    print("=" * 80)
